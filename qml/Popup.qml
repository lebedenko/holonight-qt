...
T.Popup {
    ...
    Impl.ControlPalette {
        ...
        colorGroup: !root.enabled ? Impl.ControlPalette.Disabled : (root.contentItem.Window.window && !root.contentItem.Window.window.active ? Impl.ControlPalette.Inactive : Impl.ControlPalette.Active)

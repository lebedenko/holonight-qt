...
The lowercase compatibility alias may only be removed through a separate migration plan after known consumers
adopt canonical imports. That migration is tracked by `docs/sdd/shared-controls-compatibility-removal/`.

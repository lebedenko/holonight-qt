...
[[nodiscard]] const QVector<Holonight::ThemeVariantCatalogEntry>& variants() {
  static const QVector<Holonight::ThemeVariantCatalogEntry> entries{
      ...
      {.id = QStringLiteral("holonight-frost"),
       .name = QStringLiteral("HoloNight Frost"),
       .family_id = QStringLiteral("nord"),
       .scheme = Holonight::ThemeSchemeKind::HoloNightFrost,
       .mode = Holonight::ColorMode::Dark,
       .default_accent_color = defaultAccentColor(Holonight::ThemeSchemeKind::HoloNightFrost),
       .kde_color_scheme_name = QStringLiteral("HoloNight Frost")},
      {.id = QStringLiteral("holonight-snow"),
       .name = QStringLiteral("HoloNight Snow"),
       .family_id = QStringLiteral("nord"),
       .scheme = Holonight::ThemeSchemeKind::HoloNightSnow,
       .mode = Holonight::ColorMode::Light,
       .default_accent_color = defaultAccentColor(Holonight::ThemeSchemeKind::HoloNightSnow),
       .kde_color_scheme_name = QStringLiteral("HoloNight Snow")},
      {.id = QStringLiteral("holonight-canopy"),
       .name = QStringLiteral("HoloNight Canopy"),
       .family_id = QStringLiteral("everforest"),
       .scheme = Holonight::ThemeSchemeKind::HoloNightCanopy,
       .mode = Holonight::ColorMode::Dark,
       .default_accent_color = defaultAccentColor(Holonight::ThemeSchemeKind::HoloNightCanopy),
       .kde_color_scheme_name = QStringLiteral("HoloNight Canopy")},
      {.id = QStringLiteral("holonight-glade"),
       .name = QStringLiteral("HoloNight Glade"),
       .family_id = QStringLiteral("everforest"),
       .scheme = Holonight::ThemeSchemeKind::HoloNightGlade,
       .mode = Holonight::ColorMode::Light,
       .default_accent_color = defaultAccentColor(Holonight::ThemeSchemeKind::HoloNightGlade),
       .kde_color_scheme_name = QStringLiteral("HoloNight Glade")},
  };
  return entries;
}
...
const QVector<ThemeFamilyCatalogEntry>& themeFamilies() {
  static const QVector<ThemeFamilyCatalogEntry> entries{
      ...
      {.id = QStringLiteral("nord"),
       .name = QStringLiteral("Nord"),
       .variant_ids = {QStringLiteral("holonight-frost"), QStringLiteral("holonight-snow")}},
      {.id = QStringLiteral("everforest"),
       .name = QStringLiteral("Everforest"),
       .variant_ids = {QStringLiteral("holonight-canopy"), QStringLiteral("holonight-glade")}},
  };
  return entries;
}

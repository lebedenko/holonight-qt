...
struct ColorTokens {
  ...
  QColor surfaceSelected;       // Quiet accent-tinted selected surface
  QColor surfaceSelectedHover;  // Hover state for a selected surface
  ...
  QColor textAccent;       // Accent-colored text and icons on canonical surfaces
  QColor brandForeground;  // Contrast-safe HoloNight brand text on canonical surfaces
  ...
  QColor selectionIndicator;  // High-emphasis selected edge/check indicator

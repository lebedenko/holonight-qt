...
Holonight::ThemeSchemeKind parseScheme(std::string_view value) {
  ...
  if (value == "holonight-storm" || value == "tokyonight-storm") {
    return Holonight::ThemeSchemeKind::HoloNightStorm;
  }
  if (value == "holonight-day" || value == "tokyonight-day") {
    return Holonight::ThemeSchemeKind::HoloNightDay;
  }
  ...
  if (value == "holonight-cyber-d") {
    return Holonight::ThemeSchemeKind::HoloNightCyberD;
  }
  if (value == "holonight-cyber-l") {
    return Holonight::ThemeSchemeKind::HoloNightCyberL;
  }
  if (value == "holonight-dracula" || value == "dracula") {
    return Holonight::ThemeSchemeKind::HoloNightDracula;
  }
...
std::string schemeName(Holonight::ThemeSchemeKind scheme) {
  switch (scheme) {
    ...
    case Holonight::ThemeSchemeKind::HoloNightStorm:
      return "HoloNight Storm";
    case Holonight::ThemeSchemeKind::HoloNightDay:
      return "HoloNight Day";
    ...
    case Holonight::ThemeSchemeKind::HoloNightCyberD:
      return "HoloNight Cyber D";
    case Holonight::ThemeSchemeKind::HoloNightCyberL:
      return "HoloNight Cyber L";
    case Holonight::ThemeSchemeKind::HoloNightDracula:
  ...
  for (int index = 1; index < argc; ++index) {
    ...
    if (arg == "--scheme") {
      ...
      if (mode == "dark") {
        ...
        arguments.scheme = Holonight::ThemeSchemeKind::HoloNightDay;
      } else {

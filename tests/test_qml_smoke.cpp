...
TEST_F(QmlSmoke, Button_LoadsWithoutError) {
...
TEST_F(QmlSmoke, Slider_LoadsWithoutError) {
  checkComponent(engine_, R"(import Holonight; Slider {})");
}
...
TEST_F(QmlSmoke, TabBar_LoadsWithoutError) {
  checkComponent(engine_, R"(import Holonight; TabBar {})");
}
...
TEST_F(QmlSmoke, Menu_LoadsWithoutError) {
  checkComponent(engine_, R"(import Holonight; Menu {})");
}
